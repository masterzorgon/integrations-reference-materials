...
declare function loadTokenMetadatas(cacheUrl?: string): Promise<{
...
declare const BankMetadataRaw: import("superstruct").Struct<{
    ...
    groupAddress: import("superstruct").Struct<string | undefined, null>;
...
declare function loadBankMetadatas(cacheUrl?: string): Promise<{
