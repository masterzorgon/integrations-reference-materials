...
import { AddressLookupTableAccount, Commitment, ConfirmOptions, Connection, Keypair, PublicKey, Signer, Transaction, TransactionInstruction, TransactionSignature, VersionedTransaction } from "@solana/web3.js";
...
declare class MarginfiClient {
    ...
    constructor(config: MarginfiConfig, program: MarginfiProgram, wallet: Wallet, isReadOnly: boolean, group: MarginfiGroup, banks: BankMap, priceInfos: OraclePriceMap, mintDatas: MintDataMap, feedIdMap: PythPushFeedIdMap, addressLookupTables?: AddressLookupTableAccount[], preloadedBankAddresses?: PublicKey[], bankMetadataMap?: BankMetadataMap | undefined, bundleSimRpcEndpoint?: string);
    /**
     ...
     */
    createPermissionlessBank({ mint, bankConfig, group, admin, seed, priorityFee, opts, }: {
        mint: PublicKey;
     ...
     */
    createMarginfiGroup(seed?: Keypair, additionalIxs?: TransactionInstruction[], opts?: TransactionOptions): Promise<PublicKey>;
    /**
     ...
     */
    processTransactions(transaction: VersionedTransaction[], signers?: Array<Signer>, opts?: TransactionOptions): Promise<TransactionSignature[]>;
    ...
    private sendTransactionAsBundle;
