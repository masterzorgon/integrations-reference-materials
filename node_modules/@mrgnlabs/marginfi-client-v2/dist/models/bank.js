...
exports.Bank = Bank;
class BankConfig {
    constructor(assetWeightInit, assetWeightMaint, liabilityWeightInit, liabilityWeightMaint, depositLimit, borrowLimit, riskTier, totalAssetValueInitLimit, oracleSetup, oracleKeys, oracleMaxAge, interestRateConfig, operationalState) {
    ...
    static fromAccountParsed(bankConfigRaw) {
        ...
        const oracleMaxAge = bankConfigRaw.oracleMaxAge === 0 ? constants_1.DEFAULT_ORACLE_MAX_AGE : bankConfigRaw.oracleMaxAge;
...
(function (OracleSetup) {
    ...
    OracleSetup["SwitchboardPull"] = "SwitchboardPull";
