...
import { BankConfigOpt, BankConfigOptRaw } from "./bank";
...
declare class MarginfiGroup {
    ...
    makePoolAddBankIx(program: MarginfiProgram, bankPubkey: PublicKey, bankMint: PublicKey, bankConfig: BankConfigOpt, overrideOpt: {
        admin?: PublicKey;
