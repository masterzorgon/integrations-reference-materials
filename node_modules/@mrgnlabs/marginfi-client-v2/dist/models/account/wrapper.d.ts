...
declare class MarginfiAccountWrapper {
    ...
    makeRepayWithCollatTx(repayAmount: Amount, withdrawAmount: Amount, borrowBankAddress: PublicKey, depositBankAddress: PublicKey, withdrawAll: boolean | undefined, repayAll: boolean | undefined, swapIxs: TransactionInstruction[], swapLookupTables: AddressLookupTableAccount[], priorityFeeUi?: number, isTxnSplitParam?: boolean): Promise<{
    ...
    }[], opt?: MakeWithdrawIxOpts): Promise<Transaction>;
    withdraw(amount: Amount, bankAddress: PublicKey, withdrawAll?: boolean, opt?: MakeWithdrawIxOpts): Promise<string[]>;
    makeWithdrawTx(amount: Amount, bankAddress: PublicKey, withdrawAll?: boolean, opt?: MakeWithdrawIxOpts): Promise<{
        feedCrankTxs: VersionedTransaction[];
    ...
    makeBorrowTx(amount: Amount, bankAddress: PublicKey, opt?: MakeBorrowIxOpts): Promise<{
        feedCrankTxs: VersionedTransaction[];
        borrowTx: VersionedTransaction;
        addressLookupTableAccounts: AddressLookupTableAccount[];
    }>;
    simulateBorrow(bankAddress: PublicKey, transactions: VersionedTransaction[]): Promise<SimulationResult>;
    makeWithdrawEmissionsIx(bankAddress: PublicKey): Promise<InstructionsWrapper>;
    withdrawEmissions(bankAddresses: PublicKey[], priorityFeeUi?: number): Promise<string>;
...
export declare function makeBundleTipIx(feePayer: PublicKey): TransactionInstruction;
